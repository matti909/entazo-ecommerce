...
export const LoginComponent = () => {
  ...
  const handleInstagramAuth = () => {
    // Aquí implementarías la lógica de autenticación con Instagram
    console.log("Autenticación con Instagram");
  };

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Aquí implementarías la lógica de login/registro
    console.log(isLogin ? "Login" : "Registro");
  };
